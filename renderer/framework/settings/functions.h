...
#pragma warning(push) // removing all warns from bezier shit cuz pmo we aint fixin allat
#pragma warning(disable: 4244 5055)
#include "imgui/misc/bezier/bezier.h" // bezier curve editor!!!
#pragma warning(pop)
#include "colors.h"
#include "variables.h"
#include "elements.h"
...
public:
    ...
    bool checkbox(std::string_view label, std::atomic<bool>* callback);
    ...
    void multi_dropdown(std::string_view label, bool variables[], const char* labels[], int count, bool wo_label = false);
    ...
    bool color_edit(std::string_view label, ImColor& col, bool active_alpha = true);
    bool label_color_edit(std::string_view label, float col[4], bool active_alpha = true);
    bool label_color_edit(std::string_view label, ImColor& col, bool active_alpha = true);

    bool is_key_enabled(int* key, int* mode);
    ...
    bool begin_extension(std::string_view label, ImVec2 size = { 250, 0 });
    void end_extension();
...
public:
    ...
    void text_clipped(ImDrawList* draw_list, ImFont* font, float font_size, const ImVec2& pos_min, const ImVec2& pos_max, ImU32 color, const char* text, const char* text_display_end = NULL, const ImVec2* text_size_if_known = NULL, const ImVec2& align = ImVec2(0.f, 0.f), const ImRect* clip_rect = NULL);
    ...
    void text_clipped_outline(ImDrawList* draw_list, ImFont* font, float font_size, const ImVec2& pos_min, const ImVec2& pos_max, ImU32 color, const char* text, const char* text_display_end = NULL, const ImVec2* text_size_if_known = NULL, const ImVec2& align = ImVec2(0.f, 0.f), const ImRect* clip_rect = NULL);
    ...
    void window_decorations(bool icon, ImTextureID texture);
};
